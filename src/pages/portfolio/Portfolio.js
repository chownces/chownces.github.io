...
const portfolioData = [
  {
    ...
    image: ClimbJiosImg,
    content: [
      'Architected and implemented the backend infrastructure. Presently managing deployment ops for the application',
      'Worked closely with product stakeholders to setup analytics dashboards through software tools like Retool. Presently, we have >1300 users on our platform',
